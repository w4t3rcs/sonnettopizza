...
public class OrderController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<OrderResponse> updateOrderByStatus(@PathVariable Long id, @RequestBody Status status) {
        return ResponseEntity.ok(orderService.updateOrderByStatus(id, status));
    }
